...
def default_formatting():
    ...
    formatting['data_linestyle'] = 'solid'
    ...
    for i,p_data in enumerate(panel_data):
        ...
        for j,y_d in enumerate(p_data['y_info']['series']):
            ...
            if 'field_label' not in y_d:
                y_d['field_label'] = []
            if 'data_linestyle' not in y_d:
                y_d['data_linestyle'] = formatting['data_linestyle']

            # Pull off the data
            if 'x_field' not in y_d:
                y_d['x_field'] = x_display['global_x_field']
            ...
            x = pandas_data[y_d['x_field']].to_numpy()
            y = pandas_data[y_d['y_field']].to_numpy()
